var responses = [
    ...
    "Creating a new number for your sorry ass...",
    "Why are you even using this? Well, if you insist, I will try to generate a new number for you.",
    "Sorry! New number coming up!"
]
...
function start() {
        ...
        document.getElementById("noButton").removeAttribute("disabled");
...
function reset() {
    ...
    document.getElementById("noButton").setAttribute("disabled", "false");
    document.getElementById("newButton").removeAttribute("disabled");
    document.getElementById("responseCaption").innerHTML = "";
}
